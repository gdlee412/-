...
train_df = pd.read_csv('data/22_fall_final_train_after_q1.csv')
test_df = pd.read_csv('data/22_fall_final_test_after_q1.csv')
...
train_X = train_df.drop(['station_name', 'date_time'],axis=1)  # 설명변수 선택
test_X = test_df.drop(['station_name', 'date_time'],axis=1)  # 설명변수 선택
